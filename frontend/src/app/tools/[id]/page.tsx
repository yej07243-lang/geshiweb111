      ...
      <div className="flex flex-col lg:flex-row gap-8">
        ...
        <div className="flex-1">
          <div className="glass-card rounded-[2rem] p-8 md:p-12 shadow-sm border-slate-200/60 mb-8">
            ...
            {status === "idle" && (
              <div 
                className="border-2 border-dashed border-slate-200 rounded-3xl p-12 text-center hover:border-blue-400 hover:bg-blue-50/50 transition-all cursor-pointer group"
            ...
            {status === "completed" && (
              <div className="text-center py-20 bg-emerald-50/50 rounded-[2rem] border border-emerald-100">
                ...
                <a 
                  ...
                  className="inline-flex items-center gap-3 bg-emerald-600 hover:bg-emerald-700 text-white px-10 py-4 rounded-2xl font-extrabold transition-all shadow-xl shadow-emerald-200 active:scale-95"
                >
                  <Download size={20} /> Download File
                </a>
                <button 
                  onClick={() => {setFile(null); setStatus("idle");}}
                  className="block mx-auto mt-6 text-emerald-600 font-medium hover:underline text-sm"
                >
          ...
          <div className="sticky top-8">
            ...
            <div className="mt-6 p-8 bg-gradient-to-br from-slate-900 to-slate-800 rounded-[2rem] text-white">
              ...
              <ul className="text-sm space-y-3 text-slate-300">
                <li className="flex gap-2">â˜ 100% Free</li>
                <li className="flex gap-2">â˜ No Registration</li>
                <li className="flex gap-2">â˜ SSL Encryption</li>
              </ul>
            </div>
          </div>
        </aside>
